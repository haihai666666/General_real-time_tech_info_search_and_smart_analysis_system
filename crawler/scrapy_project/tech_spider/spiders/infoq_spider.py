"""InfoQ 中文技术资讯爬虫 - 通过 RSS 获取最新软件开发/架构资讯"""
...
class InfoqSpider(BaseTechSpider):
    name = "infoq_cn"
    ...
    def parse_rss(self, response):
        ...
        logger.info("InfoQ CN: found %d items", len(items))
        ...
        for item in items:
            ...
            yield self.make_article(
                ...
                language="zh",
                authors=authors,
                tags=categories[:5] if categories else ["软件开发", "架构"],
                extra={"rss_feed": "infoq_cn"},
            )
